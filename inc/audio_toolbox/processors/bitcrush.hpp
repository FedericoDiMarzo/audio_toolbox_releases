#ifndef _AUDIO_TOOLBOX_BITCRUSH_PROCESSOR_H_
#define _AUDIO_TOOLBOX_BITCRUSH_PROCESSOR_H_
 ...
 */
class BitCrush : public MonoProcessor<BitCrush> {
  uint8_t bit_depth;
 ...
 public:
   ...
   */
  BitCrush(uint8_t bit_depth = 8, uint32_t downsample_factor = 1,
           real_type clip_threshold = 1.0f);
...
#endif  // _AUDIO_TOOLBOX_BITCRUSH_PROCESSOR_H_