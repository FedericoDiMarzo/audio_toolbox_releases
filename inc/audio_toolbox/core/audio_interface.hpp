 ...
 */
using AudioInterfaceCallback = std::function<void(const real_type*, real_type*, uint32_t)>;
...
class AudioInterface
{
  public:
     ...
     */
    AudioInterface(uint32_t sample_rate,
  ...
  private:
     ...
     */
    static void data_callback(ma_device* device, void* output, const void* input, uint32_t n_samples);
    /**
