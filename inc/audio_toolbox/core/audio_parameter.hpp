#ifndef _AUDIO_TOOLBOX_AUDIO_PARAMETER_H_
#define _AUDIO_TOOLBOX_AUDIO_PARAMETER_H_
...
class AudioParameter {
 ...
 public:
   ...
   */
  AudioParameter(real_type value, uint32_t sample_rate, uint32_t block_size,
                 float transition_ms);
...
#endif  // _AUDIO_TOOLBOX_AUDIO_PARAMETER_H_