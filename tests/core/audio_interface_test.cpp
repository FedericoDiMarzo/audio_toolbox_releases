...
void callback([[maybe_unused]] const real_type* input, real_type* output,
...
class AudioInterfaceTest : public ::testing::Test {
 protected:
  void SetUp() override { buffer_size_callback = 0; }

  void TearDown() override { buffer_size_callback = 0; }
