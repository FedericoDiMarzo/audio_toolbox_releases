  ...
  switch (pstate_) {
    case ParserEmpty:
      ...
      if (byte & kStatusByteMask) {
        ...
        incoming_message_.type =
            static_cast<MidiStatusType>((byte & kMessageMask) >> 4);
        if ((byte & 0xF8) == 0xF8)
    ...
    case ParserHasStatus:
      if ((byte & kStatusByteMask) == 0) {
        ...
        if (running_status_ == MidiStatusType::ControlChange &&
    ...
    case ParserHasData0:
      if ((byte & kStatusByteMask) == 0) {
        ...
        if (running_status_ == MidiStatusType::NoteOn &&
    ...
    case ParserSysEx:
      ...
      if (byte == 0xf7) {
        ...
        incoming_message_.sysex_data[incoming_message_.sysex_message_len] =
            byte;
